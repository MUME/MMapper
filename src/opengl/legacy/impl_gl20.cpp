...
std::optional<GLenum> Functions::toGLenum(const DrawModeEnum mode)
{
    ...
    case DrawModeEnum::QUADS:
        // GL_QUADS is deprecated in modern OpenGL.
        // Code using DrawModeEnum::QUADS may need to be updated
        // to provide 6 vertices (2 triangles) instead of 4.
        return GL_TRIANGLES; /* Original: GL_QUADS */
